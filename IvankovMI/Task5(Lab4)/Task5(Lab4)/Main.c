...
#define scan {printf("----\b\b\b\b"); scanf_s(format, inp, inp2, sizeof(inp), sizeof(inp2));}
...
char format[9];                         //строка формта для scanf_s вида "%Ns", где N - максимально разрешенная длина ввода
